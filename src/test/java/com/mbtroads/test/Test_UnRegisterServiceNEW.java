...
public class Test_UnRegisterServiceNEW extends BaseTest {

    @Test
    public void testExecutor() throws Exception {

        String modelName = "UnregisterService";

        // -------------------------------------------------
        // INIT EXTENT REPORT
        // -------------------------------------------------
        ExtentReportNEW.createReportInstance(
                currentDir + pathSeperator + "Reports_UnregisterService" +
