...
public class Test_ServiceQueryNEW extends BaseTest {

    @Test
    public void testExecutor() throws Exception {

        String modelName = "QueryService";

        // -------------------------------------------------
        // INIT EXTENT REPORT
        // -------------------------------------------------
        ExtentReportNEW.createReportInstance(
                currentDir + pathSeperator + "Reports_QueryService" +
        ...
        // 🔥 This now captures failures correctly
